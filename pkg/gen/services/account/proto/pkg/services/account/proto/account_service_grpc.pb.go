...
type AccountServiceClient interface {
	...
	CreateSshKey(ctx context.Context, in *CreateAccountRequest, opts ...grpc.CallOption) (*CreateSshKeyResponse, error)
	ListSshKeys(ctx context.Context, in *ListSshKeysRequest, opts ...grpc.CallOption) (*ListSshKeysResponse, error)
	DeleteSshKey(ctx context.Context, in *DeleteAccountRequest, opts ...grpc.CallOption) (*DeleteAccountResponse, error)
...
func (c *accountServiceClient) CreateSshKey(ctx context.Context, in *CreateAccountRequest, opts ...grpc.CallOption) (*CreateSshKeyResponse, error) {
...
func (c *accountServiceClient) DeleteSshKey(ctx context.Context, in *DeleteAccountRequest, opts ...grpc.CallOption) (*DeleteAccountResponse, error) {
	out := new(DeleteAccountResponse)
...
type AccountServiceServer interface {
	...
	CreateSshKey(context.Context, *CreateAccountRequest) (*CreateSshKeyResponse, error)
	ListSshKeys(context.Context, *ListSshKeysRequest) (*ListSshKeysResponse, error)
	DeleteSshKey(context.Context, *DeleteAccountRequest) (*DeleteAccountResponse, error)
...
func (UnimplementedAccountServiceServer) CreateSshKey(context.Context, *CreateAccountRequest) (*CreateSshKeyResponse, error) {
...
func (UnimplementedAccountServiceServer) DeleteSshKey(context.Context, *DeleteAccountRequest) (*DeleteAccountResponse, error) {
...
func _AccountService_CreateSshKey_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AccountServiceServer).CreateSshKey(ctx, req.(*CreateAccountRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _AccountService_DeleteSshKey_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AccountServiceServer).DeleteSshKey(ctx, req.(*DeleteAccountRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var AccountService_ServiceDesc = grpc.ServiceDesc{
	...
	Metadata: "pkg/services/account/proto/account_service.proto",
}
